...
type TypeWithOpenAPI = typeof Type & {
    string: (opts?: { description?: string; example?: string; examples?: string[]; format?: string; minLength?: number; maxLength?: number; pattern?: string; default?: string } & Record<string, unknown>) => TSchema & OpenAPIMetadata
    number: (opts?: { description?: string; example?: number; examples?: number[]; format?: string; minimum?: number; maximum?: number; exclusiveMinimum?: number; exclusiveMaximum?: number; multipleOf?: number; default?: number } & Record<string, unknown>) => TSchema & OpenAPIMetadata
    integer: (opts?: { description?: string; example?: number; examples?: number[]; format?: string; minimum?: number; maximum?: number; default?: number } & Record<string, unknown>) => TSchema & OpenAPIMetadata
    boolean: (opts?: { description?: string; example?: boolean; examples?: boolean[]; default?: boolean } & Record<string, unknown>) => TSchema & OpenAPIMetadata
    object: <T extends Record<string, TSchema>>(properties: T, opts?: { description?: string; title?: string; example?: Record<string, unknown>; examples?: Record<string, unknown>[]; deprecated?: boolean; additionalProperties?: boolean; minProperties?: number; maxProperties?: number } & Record<string, unknown>) => TSchema & OpenAPIMetadata
    array: <T extends TSchema>(items: T, opts?: { description?: string; example?: unknown[]; examples?: unknown[][]; minItems?: number; maxItems?: number; uniqueItems?: boolean } & Record<string, unknown>) => TSchema & OpenAPIMetadata
    enum: <T extends string[]>(values: T, opts?: { description?: string; example?: T[number]; examples?: T[number][]; title?: string }) => TSchema & OpenAPIMetadata
    literal: <T extends string | number | boolean>(value: T, opts?: { description?: string; title?: string }) => TSchema & OpenAPIMetadata
    optional: <T extends TSchema>(schema: T) => TSchema
    nullable: <T extends TSchema>(schema: T, opts?: { description?: string }) => TSchema & OpenAPIMetadata
    readOnly: <T extends TSchema>(schema: T, opts?: { description?: string }) => TSchema & OpenAPIMetadata
    writeOnly: <T extends TSchema>(schema: T, opts?: { description?: string }) => TSchema & OpenAPIMetadata
    deprecated: <T extends TSchema>(schema: T, opts?: { description?: string }) => TSchema & OpenAPIMetadata
}
...
export const t: TypeWithOpenAPI = {
    ...
    string: (opts: {
        ...
        example?: string
        examples?: string[]
        format?: 'email' | 'date' | 'date-time' | 'uuid' | 'uri' | 'hostname' | 'ipv4' | 'ipv6' | string
        minLength?: number
        maxLength?: number
        pattern?: string
        default?: string
     ...
     */
    nullable: <T extends TSchema>(schema: T, opts: { description?: string } = {}): TSchema => {
        const nullableSchema = Type.Union([schema, Type.Null()])

        if (opts.description) {
            return Object.assign({}, nullableSchema, { description: opts.description })
        }
     ...
     */
    readOnly: <T extends TSchema>(schema: T, opts: { description?: string } = {}): TSchema => {
     ...
     */
    writeOnly: <T extends TSchema>(schema: T, opts: { description?: string } = {}): TSchema => {
     ...
     */
    deprecated: <T extends TSchema>(schema: T, opts: { description?: string } = {}): TSchema => {
