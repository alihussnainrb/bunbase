...
2. Clone your fork: `git clone https://github.com/alihussnainrb/basalt.git`
3. Navigate to the project directory: `cd basalt`
...
If you have any questions, please [open an issue](https://github.com/alihussnainrb/basalt/issues/new) for discussion.
